<div class="container d-flex justify-content-evenly flex-wrap my-3">
    ...
    <div class="card card-cari-user my-2 bg-abu" style="width: 45%; height: 45%;">
        ...
        <div class="card-body">
            ...
            <a href="<?= base_url('cari_pengguna/detail/') . $user['id'] ?>"
                class="tombol-kunjungi bg-lavender">Kunjungi</a>
        </div>
    </div>
    <?php endforeach ?>
</div>