    ...
    <section class="sec-1 d-flex justify-content-center flex-wrap flex-column mt-4 mb-2 container">
        ...
        <div class="d-flex justify-content-center">
            <form action="<?= base_url('cari_pengguna/mengikuti/') . $user['id'] ?>" method="post">
                ...
                ?>
                <button type="submit" class="btn <?= $tombol ?>"><?= $ikuti ?></button>
            </form>
        </div>
        ...
        <div class="container d-flex justify-content-around my-3 mb-3">
            <div class="d-flex flex-column">
                <h5>pengikut</h5>
                <div class="text-center"><?= $jumlah_pengikut ?></div>
            </div>
            <div class="d-flex flex-column">
                <h5>mengikuti</h5>
                <div class="text-center"><?= $jumlah_mengikuti ?></div>
            </div>
            <div class="d-flex flex-column">
                <h5>kegiatan</h5>
                <div class="text-center"><?= $jumlah_kegiatan ?></div>
            </div>
        </div>
